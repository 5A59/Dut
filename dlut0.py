...
def test1(path):
    ...
    drawOutline(screen, path, black, 5, SCREEN)
    pygame.time.delay(1000)
    drawOutline(screen, path, white, 0, SCREEN)
    pygame.time.delay(1000)
...
def main():
    ...
    for f in files:
        ...
        drawOutline(screen, path, black, 1200, SCREEN)
        pygame.time.delay(1000)
        drawOutline(screen, path, white, 3000, SCREEN)
        pygame.time.delay(1000)
